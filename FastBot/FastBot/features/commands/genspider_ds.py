...
class Command(ScrapyCommand):
    ...
    def run(self, args, opts):
        ...
        if template_file:
            self._genspider(module, name, url, opts.template, template_file, attributes)
            if opts.edit:
                self.exitcode = os.system(f'scrapy edit "{name}"')

    def _genspider(self, module, name, url, template_name, template_file, attributes):
